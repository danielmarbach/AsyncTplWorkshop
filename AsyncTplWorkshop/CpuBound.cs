...
static class CpuBound
{
    public static void Compute(int numberOfElements)
    {
        ...
        Console.WriteLine($"Begin Elements {numberOfElements}/ Thread {threadId}");

        Quicksort(elements, 0, elements.Length - 1);
        
        Console.WriteLine($"Done Elements {numberOfElements}/ Thread {threadId}: '{unsorted}' => '{string.Join(",", elements)}'");
    }
